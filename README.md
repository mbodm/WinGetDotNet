...
- `WinGetDotNet` is offering an _awaitable_ method, that asynchronously starts a _WinGet_ process as _Task_ and awaits the process.
- `WinGetDotNet` returns the _WinGet_ console output and exit code, after above _awaitable_ method has finished.

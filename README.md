...
### What it is
It´s a simple and tiny .NET 6 assembly named `WinGetDotNet`, wrapping the popular Windows-App [_WinGet_](https://docs.microsoft.com/en-us/windows/package-manager/winget). _WinGet_ is a Microsoft tool, used to manage software packages on a Windows machine. `WinGetDotNet` makes it easy to integrate _WinGet_ into a .NET program.
